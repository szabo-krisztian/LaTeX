...
\textbf{Editor's proof.} If $f \in Y^\emptyset$, then $f \subset \emptyset \times Y = \emptyset$. Is $f$ a function: are there any two elements $(x, \, y), \, (x, \, z) \in \emptyset \times Y$ such that $y = z$ does not hold? 
